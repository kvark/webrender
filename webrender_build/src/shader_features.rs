...
pub fn get_shader_features(flags: ShaderFeatureFlags) -> ShaderFeatures {
    ...
    if flags.contains(ShaderFeatureFlags::PIXEL_LOCAL_STORAGE) {
        ...
        base_prim_features.add("PIXEL_LOCAL_STORAGE");
    }
    ...
    shaders.insert("ps_split_composite", features![base_prim_features.finish()]);

    shaders.insert("ps_clear", features![base_prim_features.finish()]);
